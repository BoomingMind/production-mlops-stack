...
**🌐 Live Production API**: [http://56.228.3.203:3000/](http://56.228.3.203:3000/)
...
**Production API**: [http://56.228.3.203:8000/](http://56.228.3.203:8000/)  
**Production Frontend**: [http://56.228.3.203:3000/](http://56.228.3.203:3000/)

Test the live API:
```bash
curl http://56.228.3.203:8000/health
```
...
|---------|-----------|----------------|-------------|
| **Frontend** | http://localhost:3000 | http://56.228.3.203:3000 | - |
| **MLflow UI** | http://localhost:5001 | http://56.228.3.203:5001 | - |
| **Prometheus** | http://localhost:9090 | http://56.228.3.203:9090 | - |
| **Grafana** | http://localhost:3000 | http://56.228.3.203:3001 | id: admin / pass: admin |
| **Evidently Dashboard** | (run notebooks/)http://localhost:7000 | http://56.228.3.203:7000 | - |
| **FastAPI Docs** | http://localhost:8000/docs | http://56.228.3.203:8000/docs | - |
...
7. **Monitoring**: 
   - **Evidently**: Data drift at http://56.228.3.203:7000
   - **Prometheus**: System metrics at http://56.228.3.203:9090
   - **Grafana**: Dashboards at http://56.228.3.203:3000
...
- **Tracking URI**: `http://56.228.3.203:5000` (Production) / `http://localhost:5000` (Local)
- **Features**:
...
```python
import mlflow
mlflow.set_tracking_uri("http://56.228.3.203:5000")  # Production
...
**Exposed at**: `http://56.228.3.203:7000`
...
```
Internet → EC2 Instance (56.228.3.203:8000/)
...
```bash
# Connect to EC2
ssh -i your-key.pem ubuntu@56.228.3.203:8000/
...
| Service | URL | Status |
|---------|-----|--------|
| **Frontend** | http://56.228.3.203:3000/ | ✅ Running |
| **API** | http://56.228.3.203:8000/ | ✅ Running |
| **API Docs** | http://56.228.3.203:8000/docs | ✅ Running |
| **Health Check** | http://56.228.3.203:8000/health | ✅ Running |
| **MLflow UI** | http://56.228.3.203:5000 | ✅ Running |
| **Prometheus** | http://56.228.3.203:9090 | ✅ Running |
| **Grafana** | http://56.228.3.203:3000 | ✅ Running |
...
# Make a prediction
curl -X POST "http://56.228.3.203:8000/predict" \
  -H "Content-Type: application/json" \
  -d '{
    "co": 250.5,
    "no": 0.5,
